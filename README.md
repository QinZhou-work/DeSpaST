...
# Installation
DESTINY works with Python 3.6.6. Please make sure you have the correct verion of Python.  
- (Need to test if other Python versions are compatible.)
- (Update the requirements file accordingly.)

```
conda create -n "DESTINY" python=3.6.6
conda activate DESTINY
pip install -r DESTINY_requirements.txt
```
...
- [ ] [Set up project integrations](https://git.biohpc.swmed.edu/QBRC/deep-learning/development/DESTINY/-/settings/integrations)
